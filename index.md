...
{% include_relative figures/Correlation_vs_delay_window_iteration(1)_market(NL_US).html %}
{% include_relative figures/Correlation_vs_delay_window_iteration(2)_market(NL_US).html %}
{% include_relative figures/Correlation_vs_delay_window_iteration(3)_market(NL_US).html %}
